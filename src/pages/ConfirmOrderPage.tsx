            ...
            <div className="flex max-w-[480px] flex-wrap items-end gap-4 px-4 py-3">
                <label className="flex flex-col min-w-40 flex-1">
                    ...
                    >
                        ...
                        <option value={`Din levering er klar for henting kl ${order?.user?.pickuptime?.split('kl:')[1].trim()}`}>Din levering er klar for henting kl {order?.user?.pickuptime?.split('kl:')[1].trim()} </option>
